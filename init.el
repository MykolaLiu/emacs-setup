...
(custom-set-variables
 ...
 '(package-selected-packages
   '(vundo eglot ## pcomplete-extension company-c-headers ensime powerline zone-nyan zygospore helm-gtags helm yasnippet ws-butler volatile-highlights req-package undo-tree iedit dtrt-indent counsel-projectile company clean-aindent-mode anzu)))
(custom-set-faces
